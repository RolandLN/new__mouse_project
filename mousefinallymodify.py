...
def onMouseEvent(event):
    ...
    #     f = proc.pid
    #     # print "pid-%d,name:%s" % (proc.pid, proc.name()), f
    #     # 输出window-pid和进程名
    #     if(e >= f) & (e <= f):
    #         fobj.writelines("%d  " %proc.pid)
    #         fobj.writelines("%s  " %proc.name())
    #         break
...
if __name__ == "__main__":
    ...
    # 新线程执行的代码:
    print('thread %s is running..感受一下被支配的恐惧!!   哈哈哈哈.....' % threading.current_thread().name)
